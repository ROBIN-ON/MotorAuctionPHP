...
if (isset($_GET['postid'])) 
{
    ...
    $stmt = $pdo->prepare($sql_select_comment_for_post);
    $stmt->execute([$id_post_for_comment]);
  $rowcomment_for_post = $stmt->fetchAll();
              ...
              if (is_numeric($view_comm_autor))
                  {
                    ...
                    $stmt = $pdo->prepare($sql_select_users_for_comm);
                    $stmt->execute([$view_comm_autor]);
                  $rowusers_for_comm = $stmt->fetchAll();

               ...
               foreach ($_POST['selectOneCheckBoxArray'] as $checked_Box_Post_Id)
               {
                ...
                switch ($group_options) {
                  case '1':
                    ...
                    $stmt->execute([$checked_Box_Post_Id]);
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
            ...
            <?php 
                ...
                $stmt = $pdo->prepare($sql_select_catesql_select_postgory);
                $stmt->execute([$desc]);
            ...
            <tr class="success">
             ...
             ?>
              ...
              <?php 
                    ...
                    $stmt = $pdo->prepare($sql_select_category_by_id);
                    $stmt->execute([$view_post_category]);
